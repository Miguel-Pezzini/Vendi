...
public class PhotoMapper {
    ...
    public static Photo mapToPhoto(CreatePhotoRequestDTO createPhotoRequestDTO) {
    ...
    public static List<Photo> mapToPhotos(List<CreatePhotoRequestDTO> createPhotoRequestDTOs) {
